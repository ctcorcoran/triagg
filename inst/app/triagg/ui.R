...
shinyUI(fluidPage(theme=shinythemes::shinytheme('cosmo'),
  ...
  tabsetPanel(
    ...
    tabPanel(
      ...
      br(),
      column(12,br(),
             wellPanel(rhandsontable::rHandsontableOutput("kp_data_hot"))),
      br(),
    ),
    ##############################
    ...
    tabPanel(
      ...
      column(5,
        ...
        rhandsontable::rHandsontableOutput("tri_priors_hot"),
        p('Enter the median and 75th percentile.')
      ),
      column(7,
        tags$h3('KP Proprotion Baseline Plot'),
    ...
    tabPanel(
      ...
      column(6,
             ...
             br(),
             rhandsontable::rHandsontableOutput("demo_data_hot",width=600),
             br()
             ),
      column(6,
